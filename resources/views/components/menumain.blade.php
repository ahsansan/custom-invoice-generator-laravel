    ...
    <div class="border-b">
        <button class="w-full text-left px-4 py-2 focus:outline-none {{ Request::is('site-*') ? 'bg-gray-300 rounded-b' : '' }}" onclick="toggleMenu('main-menu')">
            <span class="font-semibold flex items-center">
                ...
                &nbsp; Dashboard &nbsp;
                <svg id="main-menu-dropdown" class="w-6 h-6 text-slate-400 {{ Request::is('site-*') ? 'hidden' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-b">
        <button class="w-full text-left px-4 py-2 focus:outline-none {{ Request::is('transactions/*') ? 'bg-gray-300 rounded-b' : '' }}" onclick="toggleMenu('menu-transaction')">
            <span class="font-semibold flex items-center">
                ...
                &nbsp; Transaction &nbsp;
                <svg id="menu-transaction-dropdown" class="w-6 h-6 text-slate-400 {{ Request::is('transactions/*') ? 'hidden' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M18.425 10.271C19.499 8.967 18.57 7 16.88 7H7.12c-1.69 0-2.618 1.967-1.544 3.271l4.881 5.927a2 2 0 0 0 3.088 0l4.88-5.927Z" clip-rule="evenodd"/>
                </svg>
            </span>
        </button>
    ...
    <div class="border-b">
        <button class="w-full text-left px-4 py-2 focus:outline-none {{ Request::is('user/*') ? 'bg-gray-300 rounded-b' : '' }}" onclick="toggleMenu('menu-user')">
            <span class="font-semibold flex items-center">
                ...
                &nbsp; Users &nbsp;
                <svg id="menu-user-dropdown" class="w-6 h-6 text-slate-400 {{ Request::is('user/*') ? 'hidden' : '' }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd" d="M18.425 10.271C19.499 8.967 18.57 7 16.88 7H7.12c-1.69 0-2.618 1.967-1.544 3.271l4.881 5.927a2 2 0 0 0 3.088 0l4.88-5.927Z" clip-rule="evenodd"/>
                </svg>
            </span>
        </button>
